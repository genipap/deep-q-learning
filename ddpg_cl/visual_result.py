...
file_name1 = 'task0/result'
file_name2 = 'task1/result'
file_name3 = 'task2/result'
file_name4 = 'task3/result'
file_name5 = 'task4/result'
# file_name = 'random_v'
...
correct_key = {'crash', 'stop', 'succeess', 'not_stop', 'overspeed', 'succeess', 'unfinished'}
...
plt.plot(train_re1[0:280000], '.', label='Task 1')
plt.plot(train_re2[0:280000], '.', label='Task 2')
plt.plot(train_re3[0:280000], '.', label='Task 3')
plt.plot(train_re4[0:280000], '.', label='Task 4')
plt.plot(train_re5[0:280000], '.', label='Task 5')
...
plt.plot(results1['succeess'], '.-', color='coral', label='Task 1')
plt.plot(results2['succeess'], '.-', color='yellow', label='Task 2')
plt.plot(results3['succeess'], '.-', color='palegreen', label='Task 3')
plt.plot(results4['succeess'], '.-', color='skyblue', label='Task 4')
plt.plot(results5['succeess'], '.-', color='pink', label='Task 5')
